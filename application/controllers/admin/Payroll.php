...
class Payroll extends CI_Controller
{
    ...
    public function simpan()
    {
        ...
        $this->model->insert_payrol($kode_payroll, $tgl_payroll, $waktu_payroll, $id_pegawai, $nama_jabatan, $nama_bagian, $hadir, $sakit, $alpha, $telat, $bpjs, $pajak, $status, $channel_bayar, $image_name); //simpan ke database
