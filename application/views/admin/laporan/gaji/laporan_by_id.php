<main>
    ...
    <?php foreach ($by as $b) : ?>
        <h3>Yth. a/n <?= $b->nama ?></h3>
        <p>
            Berikut adalah bukti hasil pembayaran upah per periode <?php echo date('F Y', strtotime($b->tgl_payroll)); ?>, dan akan dirincikan dengan sebagai berikut :
        </p>
    <?php endforeach; ?>
            ...
            <tbody class="table-body-content">
                <?php foreach ($by as $row) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <center><b>Rp. <?php echo number_format($row->gaji_pokok + $row->tunjangan - $row->bpjs - $row->pajak, 0, ",", ".") ?></b>
                        </td>
                        <td>
