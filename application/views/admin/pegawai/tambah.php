                                        ...
                                        <div class="pt-4">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="nik" placeholder="Masukkan nomor KTP" value="<?php echo set_value('nik'); ?>">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <?php echo form_error('tgl_lahir', '<div class="text-danger">', '</div>'); ?>
                                                </div>
                                                <div class="form-group col-md-6">
                                        ...
                                        <div class="pt-4">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="nip" placeholder="Masukkan nip pegawai" value="<?php echo set_value('nip'); ?>">
                                                    <small><?php echo form_error('nip', '<div class="text-danger ml-2">', '</div>'); ?></small>
                                                </div>
                                                <div class="form-group col-md-6">
