                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-black mb-1 font-w600">
                                                    Rp.<?php echo number_format($row->gaji_pokok + $row->tunjangan - $row->bpjs - $row->pajak, 0, ',', '.') ?>
                                                </p>
                                                <span class="fs-14">
                                            ...
                                            <td>
                                                <div class="info mb-3">
                                                    <div class="dropdown mb-3">
                                                        <a target="_blank" href="<?php echo base_url('admin/payroll/payslip/' . $row->id_payroll) ?>" class="more-button">
