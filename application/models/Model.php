...
class Model extends CI_Model
{
    ...
    public function insert_payrol($kode_payroll, $tgl_payroll, $waktu_payroll, $id_pegawai, $nama_jabatan, $nama_bagian, $hadir, $sakit, $alpha, $telat, $bpjs, $pajak, $status, $channel_bayar, $image_name)
    {
        $data = array(
